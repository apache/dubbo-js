...
export class ConverseResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ConverseResponse
  ): ConverseResponse.AsObject
  static serializeBinaryToWriter(
...
export class IntroduceRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: IntroduceRequest
  ): IntroduceRequest.AsObject
  static serializeBinaryToWriter(
...
export class IntroduceResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: IntroduceResponse
  ): IntroduceResponse.AsObject
  static serializeBinaryToWriter(
