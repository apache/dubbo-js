...
describe('server_isolation', function () {
  ...
  const tripleOption: TripleClientServiceOptions = {
    serviceGroup: 'dubbo',
    serviceVersion: '1.0.0'
  }
  const tripleOptionErrorGroup: TripleClientServiceOptions = {
    serviceGroup: 'dobbu',
    serviceVersion: '1.0.0'
  }
  const tripleOptionErrorVersion: TripleClientServiceOptions = {
    serviceGroup: 'dubbo',
    serviceVersion: '1.0.1'
  }
  const tripleOptionLossGroup: TripleClientServiceOptions = {
    serviceVersion: '1.0.0'
  }
  const tripleOptionLossVersion: TripleClientServiceOptions = {
    serviceGroup: 'dubbo'
  }
